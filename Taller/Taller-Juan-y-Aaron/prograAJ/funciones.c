...
void pagarReserva(int numReserva, int reservas[][4], char habitaciones[][3][40], double precios[]) {
    if (numReserva != -1) {
        if (reservas[numReserva][3] == 1) {
            ...
            guardarReservas(reservas, "C:/Users/laboratorio/Desktop/Taller/reservas.txt");
        }
    } else {
...
void leerClientes(char clientes[][2][40], const char *filename) {
    FILE *file = fopen("C:/Users/laboratorio/Desktop/Taller/clientes.txt", "r");
...
void leerReservas(int reservas[][4], const char *filename) {
    FILE *file = fopen("C:/Users/laboratorio/Desktop/Taller/reservas.txt", "r");
...
void guardarClientes(char clientes[][2][40], const char *filename) {
    FILE *file = fopen("C:/Users/laboratorio/Desktop/Taller/clientes.txt", "w");
...
void guardarReservas(int reservas[][4], const char *filename) {
    FILE *file = fopen("C:/Users/laboratorio/Desktop/Taller/reservas.txt", "a+");
